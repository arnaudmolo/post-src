<div class="missions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('logo_client');?></th>
			<th><?php echo $this->Paginator->sort('emploi_id');?></th>
	...
	<tr>
		...
		<td><?php echo h($mission['Mission']['intitule']); ?>&nbsp;</td>
		<td><?php echo h($mission['Mission']['description']); ?>&nbsp;</td>
		<td><?php echo h($mission['Mission']['logo_client']); ?>&nbsp;</td>
		<td>
